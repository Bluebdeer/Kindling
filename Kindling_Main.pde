...
void gameStates() {
  ...
  case 0:     //   Main Menu   //
    ...
    textSize(25);
    fill(#2e5366);
    text("WASD to move", 25, height-50);
    textSize(25);
    fill(#2e5366);
    text("r to light campfire", 25, height-25);
    textSize(25);
    fill(#2e5366);
    text("Hold Space to scale logs", 25, height-75);
    textSize(25);
    fill(#2e5366);
    text("Hold Shift to move logs", 25, height-100);
...
void keyPressed() {
  ...
  if (key == CODED && spacePressed == false) {
    if (keyCode == SHIFT) {
